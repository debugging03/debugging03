...
Frontend developer from India. I build browser tools, web apps, and automation scripts — things that actually solve annoyances I run into. Currently learning Android dev and expanding into backend work.
